...
sequenceDiagram
  ...
  Firewall->>WebServer: Connection request flows throught the firewall to the WebServer.
  WebServer->>Firewall: Connection can't be completed due to limited resources.
